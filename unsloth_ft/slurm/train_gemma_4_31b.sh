#!/bin/bash
#SBATCH --job-name=train-gemma-4-31b
...
#SBATCH --time=3:00:00
#SBATCH --output=logs/gemma431b_%j.log
#SBATCH --error=logs/gemma431b_%j.err


# This is a SLURM script to train the Gemma 4.31B model using 
...
# run
python -u models/gemma_4_31b.py --save=False --push=True
